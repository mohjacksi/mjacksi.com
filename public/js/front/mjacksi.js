...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        Menu
        ==============================*/
        $('.header__btn__mjacksi').on('click', function () {
            $(this).toggleClass('header__btn--active');
            $('.header__menu__mjacksi').toggleClass('header__menu__mjacksi--active');
        });

        $('.header__search__mjacksi .close, .header__action--search button').on('click', function () {
            $('.header__search__mjacksi').toggleClass('header__search--active');
        });
        ...
        $(window).on("load", function () {
            $('body:not(.rtl) .slider-mjacksi').owlCarousel({
                loop: false,
                rewind: true,
                margin: 10,
                lazyLoad: true,
        ...
        /* HOME SLIDE */
        $(window).on("load", function () {
            $('body.rtl .slider-mjacksi').owlCarousel({
                loop: false,
                rewind: true,
                rtl: true,
                margin: 10,
        ...
        $('#search').on('keyup', function () {
            ...
            if ($(this).val() != "") {
                $.ajax({
                    ...
                    data: { 'project': query },
                    beforeSend: function () {
                        $('.header__search__mjacksi button i').removeClass('fa-search').addClass('fa-spinner fa-spin');
                    },

                    success: function (data) {
                        $('.header__search__mjacksi button i').removeClass('fa-spinner fa-spin').addClass('fa-search');
        ...
        $(document).on('click', '.slider-mjacksi-section, .header__content__mjacksi, .breadcrumb-area, .breadcrumb-area + div', function () {
            $('#project_list').html("");
        });
        ...
        jQuery(window).on("scroll", function () {
            (jQuery(window).scrollTop() > 250 && jQuery(window).width() > 1200 && (
                ...
                jQuery(".header__content__mjacksi").addClass("animated fadeInDown"
                )),
                jQuery(window).scrollTop() < 250 && (jQuery("body").removeClass("sticky"),
                    jQuery(".header__content__mjacksi").removeClass("animated fadeInDown")))
