                                ...
                                @if($categories)
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td data-label="name">{{$category->name}}<p class="mb-0 mt-2"><a href="{{ route('category.edit', $category->id) . '?language=' . request()->input('language')}}">{{clean( trans('mjacksi-backend.edit') , array('Attr.EnableID' => true))}}</a></p></td>
                                        </tr>
                                     @endforeach
                                @endif
