...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('mjacksi-backend.all_users') , array('Attr.EnableID' => true))}}</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('mjacksi-backend.all_users') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th>{{clean( trans('mjacksi-backend.email') , array('Attr.EnableID' => true))}}</th>
                            <th>{{clean( trans('mjacksi-backend.role') , array('Attr.EnableID' => true))}}</th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Name">
                                        ...
                                        <div class="float-left-user-name">
                                            <p>{{$user->name}}</p>
                                            <a href="{{ route('users.edit', $user->id) }}">{{clean( trans('mjacksi-backend.edit') , array('Attr.EnableID' => true))}}</a>
                                        </div>
                                    </td>
