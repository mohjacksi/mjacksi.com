...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('mjacksi-backend.edit') , array('Attr.EnableID' => true))}}</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('mjacksi-backend.edit') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="on_off_sublanguage1"> {{clean( trans('mjacksi-backend.yes') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="on_off_sublanguage0"> {{clean( trans('mjacksi-backend.no') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
