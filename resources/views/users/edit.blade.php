...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('mjacksi-backend.edit_user') , array('Attr.EnableID' => true))}}</h1>
					        ...
					        <div class="row">
					            <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    ...
					                    <input type="text" name="name" value="{{$user->name}}" class="form-control" placeholder="{{clean( trans('mjacksi-backend.name') , array('Attr.EnableID' => true))}}">
					                </div>
					            </div>
					            <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    <strong>{{clean( trans('mjacksi-backend.email') , array('Attr.EnableID' => true))}}</strong>
					                    <input type="email" name="email" value="{{$user->email}}" class="form-control" placeholder="{{clean( trans('mjacksi-backend.email') , array('Attr.EnableID' => true))}}">
					                </div>
					            </div>
					            <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					            ...
					            <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    ...
					                    <input type="text" name="address" value="{{$user->address}}" class="form-control" placeholder="{{clean( trans('mjacksi-backend.address') , array('Attr.EnableID' => true))}}">
					                </div>
					            </div>
					            <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    <strong>{{clean( trans('mjacksi-backend.city') , array('Attr.EnableID' => true))}}</strong>
					                    <input type="text" name="city" value="{{$user->city}}" class="form-control" placeholder="{{clean( trans('mjacksi-backend.city') , array('Attr.EnableID' => true))}}">
					                </div>
					            </div>
					            <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    <strong>{{clean( trans('mjacksi-backend.phone') , array('Attr.EnableID' => true))}}</strong>
					                    <input type="text" name="phone" value="{{$user->phone}}" class="form-control" placeholder="{{clean( trans('mjacksi-backend.phone') , array('Attr.EnableID' => true))}}">
					                </div>
					            </div>
					            <div class="col-xs-12 col-sm-12 col-md-12">
						            <div class="form-group">
					            ...
					            <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    <strong>{{clean( trans('mjacksi-backend.change_password') , array('Attr.EnableID' => true))}}</strong>
					                    <input type="password" name="password" class="form-control" placeholder="{{clean( trans('mjacksi-backend.change_password') , array('Attr.EnableID' => true))}}">
					                </div>
					            </div>
