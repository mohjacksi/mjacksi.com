                        ...
                        @if($pages)
                            @foreach($pages as $page)
                                <tr>
                                    ...
                                    <td class="page-title" >{{$page->title}} <p class="mb-0 mt-2"><a href="{{ route('page.edit', $page->id)  . '?language=' . request()->input('language')}}">{{clean( trans('mjacksi-backend.edit') , array('Attr.EnableID' => true))}}</a></p></a></td>
