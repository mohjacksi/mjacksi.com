...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('mjacksi-backend.title_log_favicon') , array('Attr.EnableID' => true))}}</h1>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('mjacksi-backend.title_log_favicon') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
					        ...
					        <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
					                <div class="form-group">
					                    <strong>{{clean( trans('mjacksi-backend.website_title') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <p> <strong>{{clean( trans('mjacksi-backend.logo') , array('Attr.EnableID' => true))}}</strong></p>
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.favicon') , array('Attr.EnableID' => true))}}

                                        <span>{{clean( trans('mjacksi-backend.upload_image') , array('Attr.EnableID' => true))}} <a target="_blank" href="{{route('media.create')}}"> {{clean( trans('mjacksi-backend.here') , array('Attr.EnableID' => true))}} </a> {{clean( trans('mjacksi-backend.then_copy_url') , array('Attr.EnableID' => true))}} <a target="_blank" href="{{route('media.index')}}"> {{clean( trans('mjacksi-backend.here') , array('Attr.EnableID' => true))}} </a></span>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.keywords') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.enable_disable_ogg') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="OGgraph_switch1"> {{clean( trans('mjacksi-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="OGgraph_switch0"> {{clean( trans('mjacksi-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.enable_disable_anali') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="analytics_switch1"> {{clean( trans('mjacksi-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="analytics_switch0"> {{clean( trans('mjacksi-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>

                                        <br>

                                        <strong>{{clean( trans('mjacksi-backend.tracking_code') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="pixel_switch1"> {{clean( trans('mjacksi-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="pixel_switch0"> {{clean( trans('mjacksi-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.enable_disable_schema') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="schema_switch1"> {{clean( trans('mjacksi-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="schema_switch0"> {{clean( trans('mjacksi-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <strong>{{clean( trans('mjacksi-backend.author') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="author" value="{{$setting->author}}" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <strong>{{clean( trans('mjacksi-backend.contact_address') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <strong>{{clean( trans('mjacksi-backend.price_range') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="price_range" value="{{$setting->price_range}}" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <strong>{{clean( trans('mjacksi-backend.country') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.enable_disable_whatsapp') , array('Attr.EnableID' => true))}}</strong>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="enable_disable_whatsapp1"> {{clean( trans('mjacksi-backend.on') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                          ...
                                          <label class="form-check-label" for="enable_disable_whatsapp0"> {{clean( trans('mjacksi-backend.off') , array('Attr.EnableID' => true))}}  </label>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.google_font') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.custom_css') , array('Attr.EnableID' => true))}}</strong>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.custom_js') , array('Attr.EnableID' => true))}}</strong>
