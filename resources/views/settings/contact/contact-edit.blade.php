...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('mjacksi-backend.contact_settings') , array('Attr.EnableID' => true))}}</h1>
                	...
                	<div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('mjacksi-backend.contact_info') , array('Attr.EnableID' => true))}}</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{route('contact-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.box_icon') , array('Attr.EnableID' => true))}}  {!!$setting->box_icon1!!}</strong>
                                                <input type="text" name="box_icon1" class="form-control" value="{{$setting->box_icon1}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.box_icon') , array('Attr.EnableID' => true))}}  {!!$setting->box_icon2!!}</strong>
                                                <input type="text" name="box_icon2" class="form-control" value="{{$setting->box_icon2}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.box_icon') , array('Attr.EnableID' => true))}} {!!$setting->box_icon3!!}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.box_title') , array('Attr.EnableID' => true))}}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.box_description') , array('Attr.EnableID' => true))}}</strong>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('mjacksi-backend.form_info') , array('Attr.EnableID' => true))}}</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{route('contact-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.title_form') , array('Attr.EnableID' => true))}}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.form_input_text1') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="form_input_name" class="form-control" value="{{$setting->form_input_name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.form_input_text2') , array('Attr.EnableID' => true))}}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.form_input_text3') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="form_input_budget" class="form-control" value="{{$setting->form_input_budget}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.form_input_text4') , array('Attr.EnableID' => true))}}</strong>
                                    ...
                                    <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.form_message') , array('Attr.EnableID' => true))}}</strong>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('mjacksi-backend.mail_to_email') , array('Attr.EnableID' => true))}}</strong>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('mjacksi-backend.map_info') , array('Attr.EnableID' => true))}}</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{route('contact-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                   ...
                                   <div class="form-group">
                                        <strong>{{clean( trans('mjacksi-backend.map_iframe') , array('Attr.EnableID' => true))}}</strong>
                        ...
                        <!-- Form information -->
                         ...
                         <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('mjacksi-backend.section_clients') , array('Attr.EnableID' => true))}}</h6>
                            </div>
                            <div class="card-body">
                                <a class="btn btn-primary" href="{{ route('client.index') . '?language=' . request()->input('language')}}">{{clean( trans('mjacksi-backend.view_all') , array('Attr.EnableID' => true))}}</a>
                                <a class="btn btn-primary" href="{{ route('client.create') . '?language=' . request()->input('language')}}">{{clean( trans('mjacksi-backend.create') , array('Attr.EnableID' => true))}}</a>
                            </div>
                        </div>
