...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('mjacksi-backend.all_languages') , array('Attr.EnableID' => true))}}</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('mjacksi-backend.all_languages') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="{{route('language.create')}}" class="btn btn-primary btn-back">{{clean( trans('mjacksi-backend.create_language') , array('Attr.EnableID' => true))}}</a>
                    </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th>{{clean( trans('mjacksi-backend.code_lang') , array('Attr.EnableID' => true))}}</th>
                            <th>{{clean( trans('mjacksi-backend.is_default') , array('Attr.EnableID' => true))}}</th>
                            <th>{{clean( trans('mjacksi-backend.ltr_rtl') , array('Attr.EnableID' => true))}}</th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="language-name" data-label="Name">
                                        <div class="float-left-language-name">
                                            <p>{{$language->name}}</p>
                                            <a href="{{ route('language.edit', $language->id)}}">{{clean( trans('mjacksi-backend.edit') , array('Attr.EnableID' => true))}}</a>
                                        </div>
                                    </td>
