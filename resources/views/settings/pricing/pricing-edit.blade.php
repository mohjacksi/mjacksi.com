...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('mjacksi-backend.pricing_settings') , array('Attr.EnableID' => true))}}</h1>
                	...
                	<div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <a class="btn btn-primary" href="{{ route('pricing.index') . '?language=' . request()->input('language')}}">{{clean( trans('mjacksi-backend.view_all') , array('Attr.EnableID' => true))}}</a>
                                    <a class="btn btn-primary" href="{{ route('pricing.create') . '?language=' . request()->input('language')}}">{{clean( trans('mjacksi-backend.create') , array('Attr.EnableID' => true))}}</a>
                                </div>
